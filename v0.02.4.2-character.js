...
bindCharacter=function(){
  ...
  const equipment=document.querySelector('#equipmentBtn');if(equipment)equipment.onclick=()=>modal('<h2>Equipment</h2><p class="helper"><b>Character owns equipped state.</b> Full equipment mechanics remain future scope; no duplicate equipment store is created here.</p>');
