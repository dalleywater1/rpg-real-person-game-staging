...
const V023_SHEET_IMPORT_20260918_DEFINITIONS=[
  // -- Running (8 new) --
  {achievementId:'RUN-V1-001',category:'running',type:'positive',rarity:'Common',name:'And We\'re Off',description:'Complete and record a Running activity.',systemMessage:'Movement detected. Voluntary movement, even.',series:'Running Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'RUN-V1-002',category:'running',type:'positive',rarity:'Rare',name:'Variety Is the Spice of Cardio',description:'Complete each of the five structured Running V1 workout types at least once.',systemMessage:'Five different ways to discover that running is still running.',series:'Running Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'RUN-V1-003',category:'running',type:'positive',rarity:'Uncommon',name:'Long Way Home',description:'Exceed your previous longest completed run.',systemMessage:'You could have turned around considerably earlier.',series:'Running Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'RUN-V1-004',category:'running',type:'positive',rarity:'Rare',name:'Where Did the Day Go?',description:'Exceed your previous longest-duration run.',systemMessage:'At some point this became a day trip.',series:'Running Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'RUN-V1-005',category:'running',type:'positive',rarity:'Epic',name:'Mileage Goblin',description:'Establish a new personal best for total running distance in a week.',systemMessage:'Your weekly mileage has become mildly concerning.',series:'Running Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'RUN-V1-006',category:'running',type:'positive',rarity:'Epic',name:'That Escalated Quickly',description:'Have a single run establish or improve at least three distinct Running Records.',systemMessage:'One run. Three records. Calm down.',series:'Running Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'RUN-V1-007',category:'running',type:'positive',rarity:'Uncommon',name:'Stick to the Plan',description:'Finish the run you scheduled and match the planned Running workout type.',systemMessage:'You made a plan and then actually followed it. Disturbing.',series:'Running Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'RUN-V1-008',category:'running',type:'positive',rarity:'Common',name:'Freestyle',description:'Complete a run using the Custom Run session type.',systemMessage:'Instructions rejected. Cardio retained.',series:'Running Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  // -- Gym & Strength (10 new) --
  {achievementId:'GYM-V1-001',category:'gym',type:'positive',rarity:'Common',name:'Do You Even Lift?',description:'Finish and record a Strength session.',systemMessage:'Apparently you do.',series:'Strength Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'GYM-V1-002',category:'gym',type:'positive',rarity:'Common',name:'One More Set',description:'Add at least one unplanned extra set during a Strength session.',systemMessage:'The workout was finished. You disagreed.',series:'Strength Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'GYM-V1-003',category:'gym',type:'positive',rarity:'Uncommon',name:'Copy/Paste Gains',description:'Lean heavily on the Strength Journal\'s Copy Last Set fast action.',systemMessage:'Ctrl+C. Ctrl+V. Ctrl+STR.',series:'Strength Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'GYM-V1-004',category:'gym',type:'positive',rarity:'Uncommon',name:'Again, But Heavier',description:'Exceed your previous heaviest recorded weight for an exercise under Strength\'s PB rules.',systemMessage:'Previous You has been defeated.',series:'Strength Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'GYM-V1-005',category:'gym',type:'positive',rarity:'Uncommon',name:'Rep Goblin',description:'Establish or improve a high-repetition performance recognised by Strength Records.',systemMessage:'You could have stopped several repetitions ago.',series:'Strength Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'GYM-V1-006',category:'gym',type:'positive',rarity:'Rare',name:'PB&J',description:'Earn multiple Strength Records during a single workout.',systemMessage:'Personal Bests and suffering. A classic pairing.',series:'Strength Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'GYM-V1-007',category:'gym',type:'positive',rarity:'Rare',name:'Creature of Habit',description:'Repeat one saved Strength routine ten times.',systemMessage:'Ten repetitions of the workout itself. Very meta.',series:'Strength Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'GYM-V1-008',category:'gym',type:'positive',rarity:'Epic',name:'Full Body Problem',description:'Complete a session whose exercises cover Chest, Back, Shoulders, Arms, Forearms, Core, Glutes, Legs and Full Body.',systemMessage:'No muscle group escaped.',series:'Strength Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'GYM-V1-009',category:'gym',type:'positive',rarity:'Rare',name:'No Skipping Leg Day',description:'Return to a Legs-focused workout after several consecutive non-leg Strength sessions.',systemMessage:'The investigation into the missing leg days has concluded.',series:'Strength Behaviour',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'GYM-V1-010',category:'gym',type:'positive',rarity:'Legendary',name:'Built Different',description:'Build a record portfolio spanning the full Strength body-zone system.',systemMessage:'The character sheet is beginning to look suspicious.',series:'Strength Records',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  // -- Daily Quests (22 new) --
  {achievementId:'DQ-POS-002',category:'quest',type:'positive',rarity:'Common',name:'Look Who’s Functional',description:'Clear every Daily Quest assigned for the day.',systemMessage:'All assigned tasks completed. The System was not prepared for this.',series:'Daily Quest Full Clear',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'DQ-POS-003',category:'quest',type:'positive',rarity:'Uncommon',name:'Weaponised Competence',description:'Full-clear Daily Quests for three consecutive completed days.',systemMessage:'You have converted basic responsibility into a combat style.',series:'Daily Quest Full Clear',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'DQ-NEG-001',category:'quest',type:'negative',rarity:'Common',name:'One Job',description:'Leave exactly one assigned Daily Quest incomplete at day end.',systemMessage:'You had one remaining objective. One.',series:'Quest Neglect',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'DQ-NEG-002',category:'quest',type:'negative',rarity:'Uncommon',name:'Quest Avoidance Specialist',description:'Leave three assigned Daily Quests incomplete in the same completed day.',systemMessage:'Three objectives successfully avoided. Efficiency remains questionable.',series:'Quest Neglect',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'DQ-NEG-003',category:'quest',type:'negative',rarity:'Rare',name:'Decorative Quest Log',description:'Repeatedly inspect the Daily Quest log without completing anything.',systemMessage:'Excellent quest log usage. Limited evidence of questing.',series:'Quest Neglect',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'DQ-NEG-004',category:'quest',type:'negative',rarity:'Epic',name:'Quest Debt',description:'Accumulate at least five overdue Daily Quests.',systemMessage:'Outstanding objectives have formed a small economy.',series:'Quest Neglect',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'DQ-NEG-005',category:'quest',type:'negative',rarity:'Legendary',name:'This Is Fine',description:'Accumulate ten or more overdue Daily Quests at the same time.',systemMessage:'No immediate action required. Everything is obviously excellent.',series:'Quest Neglect',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'DQ-NEG-006',category:'quest',type:'negative',rarity:'Uncommon',name:'Barely Counts, Still Counts',description:'Finish the final Daily Quest just before the day ends.',systemMessage:'A victory achieved entirely through technicality and panic.',series:'Procrastination',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  ...
  {achievementId:'DQ-NEG-008',category:'quest',type:'negative',rarity:'Uncommon',name:'Tomorrow’s Problem',description:'Reschedule the same Daily Quest three times instead of completing it.',systemMessage:'Quest successfully defeated through scheduling.',series:'Quest Delay',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'DQ-NEG-009',category:'quest',type:'negative',rarity:'Epic',name:'Quest Necromancy',description:'Finally complete a Daily Quest after repeatedly postponing it.',systemMessage:'This objective has been dead for days. Somehow, it walks.',series:'Quest Delay',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'DQ-NEG-010',category:'quest',type:'negative',rarity:'Rare',name:'Failure With Extra Steps',description:'Generate substantial activity around a Daily Quest without actually completing it.',systemMessage:'An impressive amount of activity occurred around not doing the thing.',series:'Quest Interaction',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  ...
  {achievementId:'DQ-RES-001',category:'quest',type:'positive',rarity:'Common',name:'I Meant To Do That',description:'Return to a missed Daily Quest and complete it the following day.',systemMessage:'Strategic postponement retroactively declared.',series:'Quest Recovery',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  // -- Productivity & Adulting (8 new) --
  {achievementId:'ADU-LOG-001',category:'productivity',type:'positive',rarity:'Common',name:'I Have a Plan',description:'Create the first schedule reference to a Quest, Training activity or other supported RPG source item.',systemMessage:'A plan has been created. Survival odds marginally improved.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADU-LOG-002',category:'productivity',type:'positive',rarity:'Uncommon',name:'Tomorrow Me\'s Problem',description:'Move scheduled responsibilities to tomorrow five times.',systemMessage:'Tomorrow You has filed a formal complaint.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADU-LOG-003',category:'productivity',type:'positive',rarity:'Rare',name:'Future Me Can Handle It',description:'Keep moving the same responsibility through the schedule.',systemMessage:'The problem has successfully travelled through time.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADU-LOG-004',category:'productivity',type:'positive',rarity:'Common',name:'Top Three Problems',description:'Use all three available Top Priority positions.',systemMessage:'Congratulations. You have identified the fires.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADU-LOG-005',category:'productivity',type:'positive',rarity:'Uncommon',name:'Look at Me Being Organised',description:'Build a week containing seven or more scheduled RPG references.',systemMessage:'This is suspiciously competent behaviour.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADU-LOG-006',category:'productivity',type:'positive',rarity:'Rare',name:'The Great Migration',description:'Relocate several planned items together when bulk movement becomes available.',systemMessage:'The entire week has been relocated.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADU-LOG-007',category:'productivity',type:'positive',rarity:'Common',name:'Déjà Vu',description:'Use Duplicate Event on a scheduled item.',systemMessage:'You liked that problem so much you made another one.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADU-LOG-008',category:'productivity',type:'positive',rarity:'Common',name:'I\'ll Definitely Remember This',description:'Use the Log\'s lightweight planning notes/reminders for the first time.',systemMessage:'You outsourced remembering to the System. Sensible.',series:'Adventurer\'s Log',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  // -- Personal Development (31 new) --
  {achievementId:'STAT-STR-001',category:'personalGrowth',type:'positive',rarity:'Common',name:'Do You Even Stat?',description:'Begin specialising exclusively in Strength.',systemMessage:'Three Strength increases in a row. Subtlety remains available as an optional feature.',series:'STR Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-STR-002',category:'personalGrowth',type:'positive',rarity:'Uncommon',name:'Strength Is the Answer',description:'Continue exclusive Strength development.',systemMessage:'Have you considered solving this with Strength? Of course you have.',series:'STR Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-STR-003',category:'personalGrowth',type:'positive',rarity:'Rare',name:'Dump Stat? Never Heard of It',description:'Reach a ten-increase Strength purity sequence.',systemMessage:'Other stats exist. Allegedly.',series:'STR Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-STR-004',category:'personalGrowth',type:'positive',rarity:'Epic',name:'All Points Into Strength',description:'Reach an extreme Strength specialisation sequence.',systemMessage:'Twenty-five consecutive Strength increases. The character sheet is beginning to smell like protein powder.',series:'STR Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-STR-005',category:'personalGrowth',type:'positive',rarity:'Legendary',name:'Unga Bunga Ascendant',description:'Reach the Legendary Strength purity milestone.',systemMessage:'Fifty consecutive Strength increases. Thinking is now considered an optional action.',series:'STR Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-DEX-001',category:'personalGrowth',type:'positive',rarity:'Common',name:'Quick Learner',description:'Begin specialising exclusively in Dexterity.',systemMessage:'Apparently standing still was never part of the build.',series:'DEX Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-DEX-002',category:'personalGrowth',type:'positive',rarity:'Uncommon',name:'Can\'t Touch This',description:'Continue exclusive Dexterity development.',systemMessage:'Five Dexterity increases. Objects are beginning to miss you.',series:'DEX Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-DEX-003',category:'personalGrowth',type:'positive',rarity:'Rare',name:'Reflexes Optional',description:'Reach a ten-increase Dexterity purity sequence.',systemMessage:'Ten increases. Reflexes have replaced planning.',series:'DEX Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-DEX-004',category:'personalGrowth',type:'positive',rarity:'Epic',name:'Faster Than Good Judgement',description:'Reach an extreme Dexterity specialisation sequence.',systemMessage:'Twenty-five. Your body now reacts before you\'ve finished making the bad decision.',series:'DEX Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-DEX-005',category:'personalGrowth',type:'positive',rarity:'Legendary',name:'Untouchable',description:'Reach the Legendary Dexterity purity milestone.',systemMessage:'Fifty consecutive Dexterity increases. Hitboxes are now merely suggestions.',series:'DEX Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CON-001',category:'personalGrowth',type:'positive',rarity:'Common',name:'Built to Last',description:'Begin specialising exclusively in Constitution.',systemMessage:'Three Constitution increases. Mild inconvenience resistance acquired.',series:'CON Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CON-002',category:'personalGrowth',type:'positive',rarity:'Uncommon',name:'Still Standing',description:'Continue exclusive Constitution development.',systemMessage:'Five increases. Damage has started taking this personally.',series:'CON Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CON-003',category:'personalGrowth',type:'positive',rarity:'Rare',name:'Apparently Immortal',description:'Reach a ten-increase Constitution purity sequence.',systemMessage:'Ten increases. The System has checked. You are annoyingly alive.',series:'CON Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CON-004',category:'personalGrowth',type:'positive',rarity:'Epic',name:'Too Stubborn to Die',description:'Reach an extreme Constitution specialisation sequence.',systemMessage:'Twenty-five. At this point dying would require paperwork.',series:'CON Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CON-005',category:'personalGrowth',type:'positive',rarity:'Legendary',name:'Death Has Given Up',description:'Reach the Legendary Constitution purity milestone.',systemMessage:'Fifty consecutive Constitution increases. Death has reviewed your file and decided to come back later.',series:'CON Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-INT-001',category:'personalGrowth',type:'positive',rarity:'Common',name:'Big Brain Energy',description:'Begin specialising exclusively in Intelligence.',systemMessage:'Three Intelligence increases. You may now correct people with slightly more authority.',series:'INT Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-INT-002',category:'personalGrowth',type:'positive',rarity:'Uncommon',name:'Actually, Technically…',description:'Continue exclusive Intelligence development.',systemMessage:'Five increases. You have begun sentences with ‘Actually’ at an alarming rate.',series:'INT Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-INT-003',category:'personalGrowth',type:'positive',rarity:'Rare',name:'Walking Encyclopaedia',description:'Reach a ten-increase Intelligence purity sequence.',systemMessage:'Ten increases. The wiki is considering linking to you.',series:'INT Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-INT-004',category:'personalGrowth',type:'positive',rarity:'Epic',name:'Knowledge Is Power',description:'Reach an extreme Intelligence specialisation sequence.',systemMessage:'Twenty-five. Knowledge has stopped being useful and become a competitive sport.',series:'INT Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-INT-005',category:'personalGrowth',type:'positive',rarity:'Legendary',name:'Forbidden Knowledge',description:'Reach the Legendary Intelligence purity milestone.',systemMessage:'Fifty consecutive Intelligence increases. You now know several things the System would prefer you didn\'t.',series:'INT Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-WIS-001',category:'personalGrowth',type:'positive',rarity:'Common',name:'A Moment of Clarity',description:'Begin specialising exclusively in Wisdom.',systemMessage:'Three Wisdom increases. You briefly considered the consequences.',series:'WIS Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-WIS-002',category:'personalGrowth',type:'positive',rarity:'Uncommon',name:'I Have Seen Things',description:'Continue exclusive Wisdom development.',systemMessage:'Five increases. You have begun staring thoughtfully into the middle distance.',series:'WIS Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-WIS-003',category:'personalGrowth',type:'positive',rarity:'Rare',name:'Unsolicited Wisdom',description:'Reach a ten-increase Wisdom purity sequence.',systemMessage:'Ten increases. People may soon start asking for advice. This is their mistake.',series:'WIS Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-WIS-004',category:'personalGrowth',type:'positive',rarity:'Epic',name:'Enlightenment Intensifies',description:'Reach an extreme Wisdom specialisation sequence.',systemMessage:'Twenty-five. Enlightenment appears to be getting out of hand.',series:'WIS Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-WIS-005',category:'personalGrowth',type:'positive',rarity:'Legendary',name:'The System Consults You Now',description:'Reach the Legendary Wisdom purity milestone.',systemMessage:'Fifty consecutive Wisdom increases. The System would like your opinion before proceeding.',series:'WIS Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CHA-001',category:'personalGrowth',type:'positive',rarity:'Common',name:'People Person',description:'Begin specialising exclusively in Charisma.',systemMessage:'Three Charisma increases. People are beginning to tolerate you professionally.',series:'CHA Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CHA-002',category:'personalGrowth',type:'positive',rarity:'Uncommon',name:'Smooth Talker',description:'Continue exclusive Charisma development.',systemMessage:'Five increases. You could probably talk your way out of this. Whatever this is.',series:'CHA Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  ...
  {achievementId:'STAT-CHA-004',category:'personalGrowth',type:'positive',rarity:'Epic',name:'Weaponised Personality',description:'Reach an extreme Charisma specialisation sequence.',systemMessage:'Twenty-five. Personality is now classified as a weapon.',series:'CHA Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-CHA-005',category:'personalGrowth',type:'positive',rarity:'Legendary',name:'Main Character Syndrome',description:'Reach the Legendary Charisma purity milestone.',systemMessage:'Fifty consecutive Charisma increases. Even the character sheet is listening to you.',series:'CHA Purity',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'STAT-META-001',category:'personalGrowth',type:'positive',rarity:'Legendary',name:'Jack of One Trade',description:'Demonstrate obsessive specialisation in every core Base Stat, just never all at once.',systemMessage:'You specialised in everything. Just never at the same time.',series:'Stat Obsession Meta',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  // -- App & RPG Meta (23 new) --
  {achievementId:'APP-LOG-001',category:'meta',type:'positive',rarity:'Common',name:'Welcome, Adventurer',description:'Show up for the first time.',systemMessage:'The System has noticed you. This may have been a mistake.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-002',category:'meta',type:'positive',rarity:'Common',name:'Back Again?',description:'Return on three separate days.',systemMessage:'Three visits. Either you like it here or you forgot where the exit is.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-003',category:'meta',type:'positive',rarity:'Uncommon',name:'Regular Customer',description:'Accumulate seven separate login days.',systemMessage:'Seven days logged. The System is beginning to recognize your footsteps.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-004',category:'meta',type:'positive',rarity:'Uncommon',name:'Unlucky for Some',description:'Hit the suspiciously unlucky thirteenth login day.',systemMessage:'Thirteen days. Nothing bad happened. Probably.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'APP-LOG-005',category:'meta',type:'positive',rarity:'Rare',name:'Part of the Furniture',description:'Accumulate thirty separate login days.',systemMessage:'Thirty visits. You may now legally complain about changes to the furniture.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-006',category:'meta',type:'positive',rarity:'Rare',name:'The Answer Was Logging In',description:'Reach the forty-second unique login day.',systemMessage:'Forty-two days. Apparently this was the answer after all.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'APP-LOG-007',category:'meta',type:'positive',rarity:'Rare',name:'Nice.',description:'Reach sixty-nine unique login days.',systemMessage:'Nice.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'APP-LOG-008',category:'meta',type:'positive',rarity:'Epic',name:'The System Knows Your Name',description:'Accumulate one hundred separate login days.',systemMessage:'One hundred days. Pretending this is casual seems dishonest.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-009',category:'meta',type:'positive',rarity:'Epic',name:'Definitely Not a Cult',description:'Reach one hundred and eleven unique login days.',systemMessage:'One hundred and eleven days. The robes are optional. For now.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'APP-LOG-010',category:'meta',type:'positive',rarity:'Epic',name:'Habit Formed',description:'Accumulate two hundred separate login days.',systemMessage:'Two hundred days. The System no longer considers this temporary behaviour.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-011',category:'meta',type:'positive',rarity:'Legendary',name:'Still Here',description:'Accumulate a full year\'s worth of unique login days.',systemMessage:'A full year of showing up. Disturbingly consistent.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-012',category:'meta',type:'positive',rarity:'Legendary',name:'User Not Found',description:'Reach four hundred and four unique login days.',systemMessage:'Error 404: sensible life choices not found.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'APP-LOG-013',category:'meta',type:'positive',rarity:'Legendary',name:'Stockholm Syndrome',description:'Accumulate five hundred separate login days.',systemMessage:'Five hundred days. We are beginning to suspect emotional attachment.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-LOG-014',category:'meta',type:'positive',rarity:'Legendary',name:'Terms and Conditions Accepted',description:'Reach six hundred and sixty-six unique login days.',systemMessage:'Six hundred and sixty-six days. You definitely should have read the fine print.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'APP-LOG-015',category:'meta',type:'positive',rarity:'Legendary',name:'Lucky Bastard',description:'Reach seven hundred and seventy-seven unique login days.',systemMessage:'Seven hundred and seventy-seven days. Statistically impressive. Spiritually suspicious.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'APP-LOG-016',category:'meta',type:'positive',rarity:'Celestial',name:'Persistent Little Bastard',description:'Accumulate one thousand separate login days.',systemMessage:'One thousand days. The System has stopped asking whether you are coming back.',series:'App Login',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  ...
  {achievementId:'APP-XSYS-001',category:'meta',type:'positive',rarity:'Epic',name:'Plans Within Plans',description:'Plan a Training activity using the shared RPG schedule and then complete that same referenced activity.',systemMessage:'You planned the thing, remembered the thing, and actually did the thing. The System was not prepared for this.',series:'Planning + Training',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'APP-XSYS-002',category:'meta',type:'positive',rarity:'Legendary',name:'Life Is the Ultimate RPG',description:'Meaningfully engage with the RPG\'s questing, training and adventure systems within the same rolling week.',systemMessage:'Questing. Training. Adventuring. At some point you appear to have started playing the game properly.',series:'RPG Core Systems',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  // -- Training Sports (16 new) --
  {achievementId:'TRN-TMS-001',category:'training',type:'positive',rarity:'Common',name:'Joined the Party',description:'Complete your first Team Sports session.',systemMessage:'Multiplayer activity detected.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-TMS-002',category:'training',type:'positive',rarity:'Common',name:'Team Player',description:'Complete five Team Sports sessions.',systemMessage:'Cooperation has survived five encounters.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-TMS-003',category:'training',type:'positive',rarity:'Uncommon',name:'Ten on the Team',description:'Complete ten Team Sports sessions.',systemMessage:'Ten sessions. Other humans remain involved.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-TMS-004',category:'training',type:'positive',rarity:'Rare',name:'Regular Starter',description:'Complete twenty-five Team Sports sessions.',systemMessage:'Attendance has become predictable.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-TMS-005',category:'training',type:'positive',rarity:'Epic',name:'Fifty Games In',description:'Complete fifty Team Sports sessions.',systemMessage:'Fifty sessions. The team may now notice when you are missing.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-TMS-006',category:'training',type:'positive',rarity:'Legendary',name:'Century Teammate',description:'Complete one hundred Team Sports sessions.',systemMessage:'One hundred sessions of organised cooperation.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-TMS-007',category:'training',type:'positive',rarity:'Legendary',name:'Club Veteran',description:'Complete two hundred fifty Team Sports sessions.',systemMessage:'You have become part of the furniture, but faster.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-TMS-008',category:'training',type:'positive',rarity:'Celestial',name:'Locker Room Legend',description:'Complete five hundred Team Sports sessions.',systemMessage:'Five hundred sessions. Someone should probably retire your towel.',series:'Team Sports — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'TRN-DAN-001',category:'training',type:'positive',rarity:'Common',name:'Two Left Feet',description:'Complete your first Dancing session.',systemMessage:'Movement detected. Rhythm status pending.',series:'Dancing — Session Milestones',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  ...
  // -- Adventure (72 new) --
  {achievementId:'ADV-LF-001',category:'adventure',type:'positive',rarity:'Uncommon',name:'Call Answered',description:'Complete the Walking Adventure for the first time.',systemMessage:'You found the Lost Fortress. Apparently “lost” was more of a suggestion.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-002',category:'adventure',type:'positive',rarity:'Epic',name:'The Blessed Healer',description:'Choose mercy and successfully heal the wounded Snow Yeti.',systemMessage:'The creature expected pain. You chose mercy. The System remembers.',series:'Snow Yeti',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-003',category:'adventure',type:'positive',rarity:'Rare',name:'All In',description:'Risk the player\'s entire starting fortune on Quentin’s wager.',systemMessage:'You wagered every coin you started with. Financial planning has left the party.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-004',category:'adventure',type:'positive',rarity:'Epic',name:'Put Your Money Where Your Boots Are',description:'Beat Quentin to the Pinnacle Spire after accepting his wager.',systemMessage:'You took the wager, won the race, and made Quentin pay for the privilege.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-005',category:'adventure',type:'positive',rarity:'Uncommon',name:'A Fool and His Gold',description:'Lose Quentin’s wager after betting everything.',systemMessage:'You bet everything. Quentin won. This is what experts call a learning experience.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-006',category:'adventure',type:'positive',rarity:'Uncommon',name:'Echoes in the Glade',description:'Discover Echo, the Dryad bound to the glade.',systemMessage:'You found someone the world had almost forgotten.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-007',category:'adventure',type:'positive',rarity:'Rare',name:'A Story That Refused to Die',description:'Uncover Echo’s history and open the path to her lost amulet.',systemMessage:'Some stories end. Some wait in the woods until somebody finally listens.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-008',category:'adventure',type:'positive',rarity:'Legendary',name:'Return to Sender',description:'Complete Echo’s connected Treasure Hunt and return the Leaf Amulet.',systemMessage:'After all these years, the Leaf Amulet came home. Echo no longer has to wait alone.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  ...
  {achievementId:'ADV-LF-010',category:'adventure',type:'positive',rarity:'Rare',name:'Thanks, Quentin.',description:'Turn Quentin’s sabotage into an accidental shortcut.',systemMessage:'Quentin tried to ruin your day. He accidentally found you a shortcut. Excellent work, Quentin.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-011',category:'adventure',type:'positive',rarity:'Uncommon',name:'One Piece of a Bad Idea',description:'Recover the first fragment of the map hidden around the Pinnacle Spire.',systemMessage:'One fragment found. Three more pieces of poor decision-making remain.',series:'Pinnacle Glade Map',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-012',category:'adventure',type:'positive',rarity:'Rare',name:'Something Did This',description:'Realize the wounded Yeti was not the real danger.',systemMessage:'The Yeti was not the danger. Whatever hurt it might be.',series:'Snow Yeti',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-013',category:'adventure',type:'positive',rarity:'Rare',name:'The Door Is the Beginning',description:'Reach the Pinnacle Spire and unlock its Dungeon.',systemMessage:'You reached the fortress. Unfortunately, reaching the door was apparently the easy part.',series:'Pinnacle Spire',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-014',category:'adventure',type:'positive',rarity:'Epic',name:'Please Do Not Wake It',description:'Discover what the ancient fortress was really containing.',systemMessage:'Something is sleeping beneath the Spire. The recommended strategy is extremely obvious.',series:'Sleeper Beneath the Spire',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-015',category:'adventure',type:'positive',rarity:'Uncommon',name:'I Knew You Were a Dick',description:'Experience Quentin’s betrayal.',systemMessage:'Quentin betrayed you. The System would like to congratulate absolutely nobody on being surprised.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-016',category:'adventure',type:'positive',rarity:'Epic',name:'Still Helped Him',description:'Save a rival who has given you every reason not to.',systemMessage:'He was hostile. He was insufferable. You saved him anyway. Irritatingly noble.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-017',category:'adventure',type:'positive',rarity:'Rare',name:'Professional Courtesy',description:'Win the gate confrontation without killing Quentin.',systemMessage:'You defeated Quentin and let him live. Try not to regret the second part.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-018',category:'adventure',type:'positive',rarity:'Rare',name:'Well, That Escalated',description:'End the rivalry permanently at the fortress gates.',systemMessage:'The rivalry has been permanently resolved. Very permanently.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-019',category:'adventure',type:'positive',rarity:'Uncommon',name:'Skill Issue',description:'Lose the definitive confrontation with Quentin.',systemMessage:'Quentin won. The System has reviewed the footage and has no further comment.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-020',category:'adventure',type:'positive',rarity:'Rare',name:'Catch Me Later',description:'Quentin escapes the gate confrontation into the Dungeon.',systemMessage:'Quentin escaped into the Pinnacle Spire. Because apparently this relationship needed a sequel.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  ...
  {achievementId:'ADV-LF-025',category:'adventure',type:'positive',rarity:'Uncommon',name:'The Scenic Route',description:'Take enough detours, mistakes or exploration to travel at least 50 km.',systemMessage:'The Fortress was 45 km away. You have chosen interpretive navigation.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-026',category:'adventure',type:'positive',rarity:'Rare',name:'Are We There Yet?',description:'Turn a 45 km Campaign into a substantially longer expedition through bad navigation or obsessive exploration.',systemMessage:'At some point this stopped being a route and became a lifestyle choice.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-027',category:'adventure',type:'positive',rarity:'Rare',name:'Cartography Is Hard',description:'Add five or more kilometres through wrong routes, backtracking and false leads.',systemMessage:'The map was not upside down. You were.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-028',category:'adventure',type:'positive',rarity:'Rare',name:'Not Falling for That Again',description:'Use knowledge from an earlier run to avoid every false lead already discovered.',systemMessage:'Personal growth detected. Please remain calm.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-029',category:'adventure',type:'positive',rarity:'Epic',name:'I Know a Shortcut',description:'Stack enough discovered shortcuts to remove five or more kilometres from the route.',systemMessage:'For once, “I know a shortcut” did not end in disaster.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-030',category:'adventure',type:'positive',rarity:'Legendary',name:'Leave No Stone Unturned',description:'Find every hidden location currently defined for Call to the Lost Fortress.',systemMessage:'You checked under every rock. Some of them would like privacy.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-031',category:'adventure',type:'positive',rarity:'Epic',name:'Professional Nosy Bastard',description:'Perform the one meaningful Search available at every defined searchable location encountered.',systemMessage:'You searched everything that could reasonably be searched. And several things that objected.',series:'Search the Area',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-032',category:'adventure',type:'positive',rarity:'Common',name:'Nothing to See Here',description:'Search an area thoroughly and accomplish very little.',systemMessage:'You searched. Technically.',series:'Search the Area',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-033',category:'adventure',type:'positive',rarity:'Rare',name:'That Shouldn\'t Be Here',description:'Achieve the highest Search quality band.',systemMessage:'You found something the Campaign was hoping you would walk past.',series:'Search the Area',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-034',category:'adventure',type:'positive',rarity:'Uncommon',name:'Camp Goblin',description:'Use every action offered across all camps in a single run.',systemMessage:'Not one camp action wasted. The itinerary has become sentient.',series:'Camp Actions',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-035',category:'adventure',type:'positive',rarity:'Rare',name:'Waste Not, Want Not',description:'Complete the Campaign having used every camp action available.',systemMessage:'Every rest stop optimised. Somewhere, a project manager just felt a disturbance.',series:'Camp Actions',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-036',category:'adventure',type:'positive',rarity:'Rare',name:'Who Needs Preparation?',description:'Ignore five or more opportunities to rest, search, prepare or socialise.',systemMessage:'Preparation is for people who expect consequences.',series:'Camp Actions',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-037',category:'adventure',type:'positive',rarity:'Common',name:'I Know a Guy',description:'Hire any Campaign guide.',systemMessage:'You hired professional help. Suspiciously sensible.',series:'Guides',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-038',category:'adventure',type:'positive',rarity:'Uncommon',name:'Worth Every Coin',description:'Receive the strongest standard map/guide route reduction.',systemMessage:'Turns out paying someone who knows where they are going has advantages.',series:'Guides',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-039',category:'adventure',type:'positive',rarity:'Uncommon',name:'Friends in Low Places',description:'Turn a hired guide into a genuine friend.',systemMessage:'You paid for navigation and accidentally acquired a friend.',series:'Guides',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-040',category:'adventure',type:'positive',rarity:'Epic',name:'Ride or Die',description:'Earn a guide\'s highest positive disposition.',systemMessage:'They came for the gold. They\'re staying because apparently they actually like you.',series:'Guides',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-041',category:'adventure',type:'positive',rarity:'Rare',name:'Was It Something I Said?',description:'Make a hired guide actively hostile through player treatment.',systemMessage:'Your hired professional now actively dislikes you. Impressive management.',series:'Guides',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-042',category:'adventure',type:'positive',rarity:'Epic',name:'Employee Retention Problem',description:'Drive a hired guide far enough away that they leave or oppose you.',systemMessage:'You somehow failed a performance review conducted by your own employee.',series:'Guides',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-043',category:'adventure',type:'positive',rarity:'Rare',name:'Equal Opportunities Employer',description:'Experience the Campaign with each initial guide.',systemMessage:'Three guides hired. Your adventuring business now technically has a recruitment strategy.',series:'Guides',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-044',category:'adventure',type:'positive',rarity:'Uncommon',name:'Dryad.exe Has Stopped Responding',description:'Trigger Echo\'s magical enchantment encounter.',systemMessage:'A magical status effect has entered the chat.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-045',category:'adventure',type:'positive',rarity:'Rare',name:'Not Today, Tree Lady',description:'Resist Echo\'s magical influence.',systemMessage:'Magic resisted. Questionable flirting avoided.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-046',category:'adventure',type:'positive',rarity:'Rare',name:'Oh No, She\'s Hot',description:'Succumb to Echo\'s enchantment.',systemMessage:'The saving throw was temporary. The attraction was apparently not.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-047',category:'adventure',type:'positive',rarity:'Epic',name:'Muscles Have Entered the Conversation',description:'Discover Echo\'s hidden Strength-based attraction interaction.',systemMessage:'Apparently Strength was a dialogue option.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-048',category:'adventure',type:'positive',rarity:'Epic',name:'Trust Exercise',description:'Earn Echo\'s highest specified positive relationship state.',systemMessage:'For someone bound to a glade with trust issues, this is considerable progress.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-049',category:'adventure',type:'positive',rarity:'Epic',name:'How Do You Piss Off a Dryad?',description:'Drive Echo to her most negative specified relationship state.',systemMessage:'You found a lonely magical woman trapped in a forest for years and somehow made her hate you. Outstanding.',series:'Echo',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-050',category:'adventure',type:'positive',rarity:'Uncommon',name:'It\'s More Afraid of You',description:'Recognise that the wounded Yeti is frightened rather than simply aggressive.',systemMessage:'Large, wounded and terrified. Relatable.',series:'Snow Yeti',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-051',category:'adventure',type:'positive',rarity:'Rare',name:'Easy, Big Guy',description:'Successfully calm the frightened Yeti.',systemMessage:'Several hundred kilos of panic have been successfully de-escalated.',series:'Snow Yeti',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  ...
  {achievementId:'ADV-LF-053',category:'adventure',type:'positive',rarity:'Epic',name:'You Monster',description:'Kill the wounded Yeti despite knowing it is frightened.',systemMessage:'It was wounded. It was frightened. You knew both of these things. The System is judging you.',series:'Snow Yeti',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-054',category:'adventure',type:'positive',rarity:'Uncommon',name:'Nope.',description:'Choose discretion and avoid the Yeti encounter.',systemMessage:'A tactical withdrawal is still tactical.',series:'Snow Yeti',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-055',category:'adventure',type:'positive',rarity:'Uncommon',name:'This Is Becoming a Thing',description:'Recover a second permanently registered map fragment.',systemMessage:'Two fragments. This has officially stopped being a coincidence.',series:'Pinnacle Glade Map',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-056',category:'adventure',type:'positive',rarity:'Rare',name:'Well Now We Have to Finish It',description:'Recover three permanently registered map fragments.',systemMessage:'Three fragments. Walking away now would be psychologically impossible.',series:'Pinnacle Glade Map',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-057',category:'adventure',type:'positive',rarity:'Epic',name:'X Marks the Poor Decision',description:'Complete the four-part Pinnacle treasure map.',systemMessage:'Four fragments. Congratulations. You have assembled a map telling you where your next problem is.',series:'Pinnacle Glade Map',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-058',category:'adventure',type:'positive',rarity:'Epic',name:'Treasure Hunter',description:'Turn the completed four-fragment map into a new Treasure Quest.',systemMessage:'Congratulations. The treasure map has successfully generated more work.',series:'Pinnacle Glade Map',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-059',category:'adventure',type:'positive',rarity:'Uncommon',name:'We\'re Not Friends',description:'Establish Quentin as a proper rival.',systemMessage:'Mutual dislike has matured into a structured relationship.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-060',category:'adventure',type:'positive',rarity:'Rare',name:'Are We Friends Now?',description:'Develop a genuinely positive relationship with Quentin.',systemMessage:'This was not how the rivalry was supposed to go.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-061',category:'adventure',type:'positive',rarity:'Epic',name:'Against All Good Judgement',description:'Turn Quentin into an ally.',systemMessage:'Against considerable evidence, you have decided to trust Quentin. Bold.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-062',category:'adventure',type:'positive',rarity:'Legendary',name:'Character Development',description:'Resolve the canonical Quentin relationship through reconciliation.',systemMessage:'Against considerable evidence, personal experience and basic common sense, you and Quentin worked things out.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-063',category:'adventure',type:'positive',rarity:'Rare',name:'Know When to Fold \'Em',description:'Force or persuade Quentin to surrender.',systemMessage:'Quentin has discovered the ancient tactical art of knowing when to stop.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  ...
  {achievementId:'ADV-LF-065',category:'adventure',type:'positive',rarity:'Rare',name:'This Is Awkward',description:'Arrive at the final gate confrontation dead even with Quentin.',systemMessage:'Forty-five kilometres later and neither of you has managed to win the argument.',series:'Lord Quentin',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-066',category:'adventure',type:'positive',rarity:'Rare',name:'A Different Road',description:'Complete two different Stage-3 routes across Campaign runs.',systemMessage:'A new road, containing an exciting selection of different problems.',series:'Three Roads',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  ...
  {achievementId:'ADV-LF-068',category:'adventure',type:'positive',rarity:'Uncommon',name:'What If I Do This?',description:'Begin and complete a replay using a previously unlocked Campaign Variant.',systemMessage:'Canon has left the building.',series:'Campaign Variants',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:false,isSecret:false,revealAnimation:null},
  {achievementId:'ADV-LF-069',category:'adventure',type:'positive',rarity:'Epic',name:'Alternate Timeline Enjoyer',description:'Finish five meaningfully distinct replay Variant configurations.',systemMessage:'Five alternate timelines explored. Canon is starting to look nervous.',series:'Campaign Variants',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-070',category:'adventure',type:'positive',rarity:'Legendary',name:'Loose Ends',description:'Discover every major piece of connected content branching from Call to the Lost Fortress.',systemMessage:'Four loose ends found. Naturally, each one leads somewhere worse.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-071',category:'adventure',type:'positive',rarity:'Legendary',name:'Nothing Left to Find',description:'Exhaust the Campaign\'s registered hidden discovery structure across canonical play and replays.',systemMessage:'You found everything. Even the things that were hiding for a reason.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
  {achievementId:'ADV-LF-072',category:'adventure',type:'positive',rarity:'Celestial',name:'The Fortress Remembers',description:'Fully master Call to the Lost Fortress: every required road, secret, mistake, choice and outcome.',systemMessage:'Every road. Every secret. Every mistake. Every choice. There is nothing left for the Fortress to hide from you.',series:'Lost Fortress',triggerType:'pendingDesign',triggerValue:null,iconAsset:V023_ACHIEVEMENT_PLACEHOLDER_ICON,frameAsset:null,xpReward:null,lootReward:null,hidden:true,isSecret:true,revealAnimation:null},
];
